...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "meals.minimum_meals_selection": "Select at least 1 recipe to generate a plan.",
  ...
  ru: {
    ...
    "meals.minimum_meals_selection": "Выберите минимум 1 рецепт для плана.",
  ...
  he: {
    ...
    "meals.minimum_meals_selection": "בחר לפחות מתכון אחד ליצירת תוכנית.",
