...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "meals.selectedRecipesPanel": "Selected recipes",
    "meals.noRecipesSelected": "No recipes selected yet",
    ...
    "meals.ingredientsButton": "Ingredients",
    "meals.ingredientsNotAvailable": "Ingredients not available",
    "meals.removeFromSelection": "Remove from selection",
  ...
  ru: {
    ...
    "meals.selectedRecipesPanel": "Выбранные рецепты",
    "meals.noRecipesSelected": "Рецепты ещё не выбраны",
    ...
    "meals.ingredientsButton": "Ингредиенты",
    "meals.ingredientsNotAvailable": "Ингредиенты недоступны",
    "meals.removeFromSelection": "Убрать из выбранных",
  ...
  he: {
    ...
    "meals.selectedRecipesPanel": "מתכונים שנבחרו",
    "meals.noRecipesSelected": "עדיין לא נבחרו מתכונים",
    ...
    "meals.ingredientsButton": "מרכיבים",
    "meals.ingredientsNotAvailable": "מרכיבים לא זמינים",
    "meals.removeFromSelection": "הסר מהבחירה",
